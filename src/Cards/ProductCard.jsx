...
const ProductCard = ({Data}) => {
  return (
        <div className="flex flex-col md:flex-row justify-between  border-8 bg-slate-200 border-slate-200 rounded-lg sm:w-11/12  w-[380px] mx-auto shadow-sm shadow-black/30">
            <div className="flex flex-col md:flex-row items-center overflow-hidden sm:w-full">
                ...
                <div className="flex flex-col justify-center bg-slate-200  h-full px-5 py-4 w-full">
                    <p className='text-black md:text-[20px] font-semibold mb-4'>{Data.Product}</p>
            ...
            <div className=" flex flex-col justify-center bg-slate-200  px-5 mx-auto">
               <div className='flex flex-row gap-x-16 mb-8 items-center '>
