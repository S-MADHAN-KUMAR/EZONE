...
const Banner = () => {
  return (
   ...
   <div>
      ...
      <button className='bg-blue-700 px-8 font-bold text-white py-2 sm:text-lg rounded-full hover:scale-105 duration-200'>
      Shop Now
      </button>
    </div>
    <div className='hidden md:flex w-[700px] h-80 overflow-hidden rounded-xl '>
